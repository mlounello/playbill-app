              ...
              <article key={task.task_id} className="card card-soft">
                <div className="row-between">
                  <div>
                    ...
                    <div className="meta-text">{task.submission_label || getSubmissionTypeLabel(task.submission_type)} task</div>
                  ...
                  <div className="link-row">
                    ...
                    {task.show_is_published ? <Link href={`/p/${task.show_slug}`}>Preview Program</Link> : null}
                  </div>
                </div>
              </article>
            ))}
